...
// ---- Helper Function: Request to Backend Service ----
...
if (preg_match('#^/sub/([a-zA-Z0-9]+)#', $requestUri, $matches)) {
    ...
    if ($isBrowser) {
        // ---- Browser Mode: Show beautiful HTML page with full details ----
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <p>User ID: <code>' . htmlspecialchars($data['user_id'] ?? 'Unknown') . '</code></p>
                </div>';
        ...
        echo '
                <div class="footer">
                    ...
                    <div style="margin-top: 8px; font-size: 0.8rem; color: #64748b;">
                        🔗 Unified Subscription Link (for import in clients)
                    </div>
                </div>
            </div>
    ...
    // ---- VPN Client Mode: Return plain subscription (base64 / text) ----
...
echo "✅ Subscription proxy is active.<br>Use <b>/sub/YOUR_TOKEN</b> to get your subscription.";
